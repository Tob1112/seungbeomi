...
DROP TABLE shain;
DROP TABLE kinmuhyo;
DROP TABLE kinmuhyoShosai;
DROP TABLE jikokuhyo;
DROP TABLE code;
...
-- 勤務表詳細
CREATE TABLE kinmuhyoShosai (nengetsu TEXT, hizuke TEXT, yasumiKubun TEXT, shigyoJikan TEXT, shigyoJikanchi REAL, syuryoJikan TEXT, syuryoJikanchi REAL, kyukeiJikan REAL, jitsudoJikan REAL, sagyoNaiyo TEXT);
-- 時刻表
