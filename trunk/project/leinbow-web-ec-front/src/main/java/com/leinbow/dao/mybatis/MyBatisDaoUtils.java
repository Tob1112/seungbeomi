...
/**
 * General MyBATIS Utilities class with rules for primary keys and
 * query names.
 *
...
public final class MyBatisDaoUtils {
     ...
     */
    protected final static Logger logger = LoggerFactory.getLogger(MyBatisDaoUtils.class);
    ...
    protected static Object getPrimaryKeyValue(Object o) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Could not invoke method '" + getterMethod + "' on " + ClassUtils.getShortName(o.getClass()));
        }
        return null;
    }
    ...
    protected static void prepareObjectForSaveOrUpdate(Object o) {
        try {
            ...
            e.printStackTrace();
            logger.error("Could not prepare '" + ClassUtils.getShortName(o.getClass()) + "' for insert/update");
        }
    }
    ...
    protected static void setPrimaryKey(Object o, Class clazz, Object value) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error(MessageFormat.format("Could not set ''{0}.{1} with value {2}",
