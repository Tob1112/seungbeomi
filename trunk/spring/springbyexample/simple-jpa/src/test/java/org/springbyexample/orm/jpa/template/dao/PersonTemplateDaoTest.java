...
import org.springbyexample.orm.jpa.template.dao.PersonTemplateDao;
...
public class PersonTemplateDaoTest {

    final Logger logger = LoggerFactory.getLogger(PersonTemplateDaoTest.class);
    
    @Autowired
    protected PersonTemplateDao personDao = null;
