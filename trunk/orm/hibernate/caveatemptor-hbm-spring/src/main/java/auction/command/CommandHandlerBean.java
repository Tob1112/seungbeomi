 ...
 * <p>
 * This implementation injects a data access object factory into the data access
 * commands. Alternatively, without a DAO layer, you could inject an
 * EntityManager directly into the data access commands, and the
 * CommandHandlerBean would get the EntityManager injected by the EJB container.
 * 
