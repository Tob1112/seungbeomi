...
/**
 * <p>
 * HSQL DB specific initializing <code>DriverManagerDataSource</code>. If values
 * aren't set for driver class name, url, username, or password defaults for an
 * in memory HSQL DB are used.
 * </p>
 *
 * <p>
 ...
 */
public class HsqldbInitializingDriverManagerDataSource extends
		InitializingDriverManagerDataSource implements InitializingBean {

	protected static String DRIVER_CLASS_NAME = "org.hsqldb.jdbcDriver";
	protected static String MEMORY_URL = "jdbc:hsqldb:mem:Test";
	protected static String SERVER_URL = "jdbc:hsqldb:hsql://localhost";
