...
public class FriendUtils {
	...
	public static Key getKeyForName(String lastName, String firstName) {
		return KeyFactory.createKey(Friend.class.getSimpleName(), lastName
				+ ", " + firstName);
	}

	public static void addFriendTo(String lastName, String firstName,
			String friendLastName, String friendFirstName) {
		PersistenceManager pm = PMF.get().getPersistenceManager();

		String meKey = KeyFactory
				.keyToString(getKeyForName(lastName, firstName));
		String otherKey = KeyFactory.keyToString(getKeyForName(friendLastName,
				friendFirstName));
		...
		try {
			...
			try {
				...
				List<String> replacementFriends = new ArrayList<String>(other
						.getFriendKeys());
		...
		try {
			...
			try {
				...
				List<String> replacementFriends = new ArrayList<String>(me
						.getFriendKeys());
