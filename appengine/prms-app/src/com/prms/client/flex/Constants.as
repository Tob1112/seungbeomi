package com.prms.client.flex {
    ...
    public class Constants {
        ...
        /** 定数ステータス ：3(type:int)  */
        public static const CONST_INT_THREE:int = 3;
        ...
        //	MAIN CONSTANTS
        // ---------------------------------------------------------------------
        public static const LAYOUT_LOGIN:String = "layout_login";
        public static const LAYOUT_USER:String = "layout_user";
        public static const LAYOUT_ADMIN:String = "layout_admin";
        ...
        /** 交通費通勤分非定期（ユーザ）*/
        public static const USER_TRAFFIC_IRREGULAR:String = "userTrafficIrregular";
        // ---------------------------------------------------------------------
        //	TIMESHEET CONSTANTS
        // ---------------------------------------------------------------------
        /** 勤務表（ユーザ）画面ID */
        ...
        public static const STATUS_USER_TRAFFIC:String = "traffic";	                // 交通費
        ...
        //	OTHER CONSTANTS
        // ---------------------------------------------------------------------
        public static const FILE_UPLOAD_URL:String = "http://localhost:8080/prms/upload";
        public static const FILE_DOWNLOAD_URL:String = "http://localhost:8080/prms/document/worksheet.xls";
        ...
        /** VIEWSTACK ログイン */
        public static const VIEWSTACK_LOGIN:int = 0;
        /** VIEWSTACK ユーザ */
        public static const VIEWSTACK_USER:int = 1;
        /** VIEWSTACK 管理者 */
        public static const VIEWSTACK_ADMIN:int = 2;
    }
}
