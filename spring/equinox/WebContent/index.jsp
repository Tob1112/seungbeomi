...
<div id="main">
    ...
    <p>
        <a href="http://equinox.dev.java.net">Equinox</a> is a lightweight version of <a href="http://appfuse.org">AppFuse</a>.
        ...
        with Equinox can be found in the <a href="http://sourcebeat.com/titles/springlive/public/Rev_11/SpringLive_SampleChapter.pdf">
...
<div id="readmore" style="display:none">
    ...
    <p>
        By default, Equinox expects you to have PostgreSQL installed with
        an "equinox" database created. For everything to work out-of-the-box,
