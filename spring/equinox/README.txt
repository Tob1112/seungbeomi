...
==================
 About Equinox
==================
Equinox is a lightweight version of AppFuse (http://appfuse.org). I was inspired 
to create it while writing Spring Live (http://springlive.com) and looking at 
the struts-blank and webapp-minimal applications that ship with Struts and 
Spring, respectively. These "starter" apps were not robust enough for me, and I 
wanted something like AppFuse, only simpler. 
...
* Forums: http://www.nabble.com/Equinox-Users-f13630.html
...
PostgreSQL is the default database and you will need to create a "equinox" 
...
If you'd prefer to use Ant rather than Maven, you will need to tell Equinox 
...
NOTE: These instructions where written before Equinox followed Maven's 
...
command line, cd into the equinox directory and type "mvn eclipse:eclipse". If 
...
Project > Java Project. Click Next and type "equinox" in the Project name box. 
...
NOTE: You can use Maven 2 or Ant to build/test/deploy an Equinox-based project.
