 ...
 * <p>
 * The escrow service may be in the context of an auction, or utilized by all
 * users for deals made outside of CaveatEmptor. Hence, the auction
 * <tt>Item</tt> reference is optional and may be null.
 * 
...
public class Shipment {
	 ...
	 * Regular constructor
	 */
	public Shipment(AddressEntity deliveryAddress, User buyer, User seller,
	...
	public boolean equals(Object o) {
		...
		if (inspectionPeriodDays != shipment.inspectionPeriodDays)
			return false;
		if (!buyer.getId().equals(shipment.buyer.getId()))
			return false;
		if (!created.equals(shipment.created))
			return false;
	...
	public String toString() {
		return "Shipment ('" + getId() + "'), " + "State: '" + getState() + "'";
	}
