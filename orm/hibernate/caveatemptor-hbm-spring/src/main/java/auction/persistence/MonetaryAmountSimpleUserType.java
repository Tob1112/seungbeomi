 ...
 * numeric column to hold monetary amounts. Every <tt>MonetaryAmount</tt> will
 * be converted to USD (using some conversion magic of the class itself) and
...
public class MonetaryAmountSimpleUserType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, Object owner)
		...
		if (resultSet.wasNull())
			return null; // Has to be done after first read
