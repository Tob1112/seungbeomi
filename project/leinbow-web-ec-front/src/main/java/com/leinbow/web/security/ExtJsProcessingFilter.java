package com.leinbow.web.security;
 ...
 * @author moretajoo
 *
 * ExtJs用login画面で利用するspring security filter
 *
 */
public class ExtJsProcessingFilter extends UsernamePasswordAuthenticationFilter {
